...
class InvoiceItemController extends Controller
{
    public function index()
    {
        try {
            ...
            return response()->json($invoiceItems, 200);
        } catch (\Exception $e) {
    ...
    public function show(InvoiceItem $invoiceItem)
    {
        try {
            ...
            Log::error('Error fetching invoice item: ' . $e->getMessage());
            return response()->json(['error' => 'Failed to retrieve invoice item. Please try again later.'], 500);
        }
    }
